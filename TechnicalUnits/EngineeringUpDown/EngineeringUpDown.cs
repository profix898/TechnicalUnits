...
//using System.Linq;
//using EMG.Controls.EngineeringUpDown.MathExpressions;
//using TechnicalUnits.EngineeringUpDown.MathExpressions;
...
//            upDownTextbox = EMG.Controls[1] as TextBox;
...
//        public string DoubeToEngString(double val) { // conversion method with current options and no side effects
//            string str = "";
//            str = engineeringNotation.NumberToString(val);
//            return str;
//        }
...
//                    if (value != 0)
//                    {
//                        var exp1 = Math.Floor(Math.Log10(Math.Abs(value))); // Get the exponent of 10 for the value
//                        var dynamicIncrement = Math.Pow(10, exp1); // Calculate the value of the highest position

//                        // Next value would be zero or very close to it
//                        if (NearlyEqual(dynamicIncrement, -1 * value, ApproxEpsilon))
//                            dynamicIncrement = Math.Pow(10, Math.Floor(Math.Log10(Math.Abs(value / 10))));
...
//                    var dynamicIncrement = Math.Pow(10, 3 * exp3);
...
//                    var valueBeforeRelativeDecSep = Math.Floor(value / Math.Pow(1000, exp3));
...
//                    if (value != 0)
//                    {
//                        var exp1 = (int) Math.Floor(Math.Log10(Math.Abs(value))); // Get exponent of 10 for value
//                        value += Math.Pow(10, exp1); // Increase value by the highest position value
//                    }
//                    else
//                    {
...
//                else if (ModifierKeys == Keys.Alt)
//                    value += Math.Pow(10, 3 * GetExp3Value(value));
...
//            Exp3 = GetExp3Value(value);
//            Text = engineeringNotation.NumberToString(value);
...
//                    {
//                        var exp1 = Math.Floor(Math.Log10(Math.Abs(value))); // Get the exponent of 10 for the value
//                        var dynamicDecrement = Math.Pow(10, exp1); // Calculate the value of the highest position

//                        if (NearlyEqual(dynamicDecrement, value, ApproxEpsilon))
//                            // Next value would be zero or very close to it
//                            dynamicDecrement = Math.Pow(10, Math.Floor(Math.Log10(Math.Abs(value / 10))));
...
//                {
//                    double exp3 = GetExp3Value(value);
//                    var dynamicDecrement = Math.Pow(10, 3 * exp3);
//                    // Decrement at the position before the decimal separator (ignoring the SI prefix following, i.e. we use the relative decimal separator, not the absolute including the SI prefix)
...
//            else if (e.Delta < 0)
//            {
//                for (var i = 0; i < Math.Abs(e.Delta) / SystemInformation.MouseWheelScrollDelta; i++)
//                    DownButton();
//            }
//        }
...
//                case Keys.Right:
//                {
//                    var textBox = EMG.Controls[1] as TextBox;
//                    if (textBox != null)
//                    {
...
//                    mathEval = new MathEvaluator { EngNotation = engineeringNotation };

//                value = mathEval.Evaluate(str, warnings);
//            }
//            else
//            {
//                value = engineeringNotation.StringToNumber(str, warnings);
//            }
