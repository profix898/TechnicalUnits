...
public class TechnicalUnitsUpDown : TemplatedControl, ITechnicalUnitsControl, ITechnicalUnitsControlImpl
{
    ...
    /// </summary>
    public static readonly StyledProperty<UnitOptions> UnitOptionsProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, UnitOptions>(nameof(UnitOptions), new UnitOptions());

    /// <summary>
    /// Defines the <see cref="EnableMath"/> property
    /// </summary>
    public static readonly StyledProperty<bool> EnableMathProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, bool>(nameof(EnableMath));

    /// <summary>
    /// Defines the <see cref="MathModeIcon"/> property
    /// </summary>
    public static readonly StyledProperty<object?> MathModeIconProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, object?>(nameof(MathModeIcon),
                                                                 new TextBlock
                                                                 {
    ...
    public static readonly StyledProperty<double> MinimumProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, double>(nameof(Minimum), Double.MinValue);

    /// <summary>
    /// Defines the <see cref="Maximum"/> property
    /// </summary>
    public static readonly StyledProperty<double> MaximumProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, double>(nameof(Maximum), Double.MaxValue);

    /// <summary>
    /// Defines the <see cref="ClipValueToMinMax"/> property
    /// </summary>
    public static readonly StyledProperty<bool> ClipValueToMinMaxProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, bool>(nameof(ClipValueToMinMax), true);
    ...
    public static readonly StyledProperty<double> IncrementProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, double>(nameof(Increment), 1.0);

    /// <summary>
    /// Defines the <see cref="IncrementMult"/> property
    /// </summary>
    public static readonly StyledProperty<double> IncrementMultProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, double>(nameof(IncrementMult), 10.0);

    /// <summary>
    /// Defines the <see cref="IsReadOnly"/> property
    /// </summary>
    public static readonly StyledProperty<bool> IsReadOnlyProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, bool>(nameof(IsReadOnly));

    /// <summary>
    /// Defines the <see cref="Value"/> property
    /// </summary>
    public static readonly StyledProperty<double> ValueProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, double>(nameof(Value), 1000.0, coerce: (s, v) => ((TechnicalUnitsUpDown) s).OnCoerceValue(v), defaultBindingMode: BindingMode.TwoWay, enableDataValidation: true);
    ...
    public static readonly StyledProperty<bool> AllowSpinProperty =
        ButtonSpinner.AllowSpinProperty.AddOwner<TechnicalUnitsUpDown>();
    ...
    public static readonly StyledProperty<Location> ButtonSpinnerLocationProperty =
        ButtonSpinner.ButtonSpinnerLocationProperty.AddOwner<TechnicalUnitsUpDown>();

    /// <summary>
    /// Defines the <see cref="ShowButtonSpinner"/> property.
    /// </summary>
    public static readonly StyledProperty<bool> ShowButtonSpinnerProperty =
        ButtonSpinner.ShowButtonSpinnerProperty.AddOwner<TechnicalUnitsUpDown>();

    /// <summary>
    /// Defines the <see cref="Watermark"/> property.
    /// </summary>
    public static readonly StyledProperty<string?> WatermarkProperty =
        AvaloniaProperty.Register<TechnicalUnitsUpDown, string?>(nameof(Watermark));
    ...
    public static readonly StyledProperty<VerticalAlignment> VerticalContentAlignmentProperty =
        ContentControl.VerticalContentAlignmentProperty.AddOwner<TechnicalUnitsUpDown>();

    /// <summary>
    /// Defines the <see cref="TextAlignment"/> property
    /// </summary>
    public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
        TextBox.TextAlignmentProperty.AddOwner<TechnicalUnitsUpDown>();

    /// <summary>
    /// Defines the <see cref="InnerLeftContent"/> property
    /// </summary>
    public static readonly StyledProperty<object?> InnerLeftContentProperty =
        TextBox.InnerLeftContentProperty.AddOwner<TechnicalUnitsUpDown>();

    /// <summary>
    /// Defines the <see cref="InnerRightContent"/> property
    /// </summary>
    public static readonly StyledProperty<object?> InnerRightContentProperty =
        TextBox.InnerRightContentProperty.AddOwner<TechnicalUnitsUpDown>();
    ...
    {
        get { return GetValue(FormattingOptionsProperty); }
    ...
    {
        get { return GetValue(UnitOptionsProperty); }
    ...
    public Unit Unit
    {
        get { return GetValue(UnitOptionsProperty).Unit; }
        set { SetValue(UnitOptionsProperty, value); }
    }
    ...
    {
        get { return GetValue(EnableMathProperty); }
    ...
    {
        get { return GetValue(MathModeIconProperty); }
    ...
    {
        get { return GetValue(ClipValueToMinMaxProperty); }
    ...
    {
        get { return GetValue(IncrementMultProperty); }
    ...
    protected virtual void OnValueChanged(double? oldValue, double? newValue)
    {
        ...
        RaiseEvent(new TechnicalUpDownValueChangedEventArgs(ValueChangedEvent, oldValue, newValue));
    }
    ...
    {
        return value; // Standard validation (min/max) inside mixin, so just return the value.
    }
