...
public class NumericUpDown : TemplatedControl
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="Avalonia.Media.TextAlignment"/> of the <see cref="NumericUpDown"/>
    /// </summary>
    ...
    {
        return System.Math.Max(baseValue, Minimum);
    }
    ...
    {
        return System.Math.Min(baseValue, Maximum);
    }
